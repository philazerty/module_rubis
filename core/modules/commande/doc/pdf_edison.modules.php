...
/**
 *	Classe to generate PDF orders with template edison
 */
class pdf_edison extends ModelePDFCommandes
{
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $titlekey="Order")
	{
		...
		// Logo spécifique EDISON / EDISON Specific logo
		// Update by Philazerty 13/11/2017
		if (!empty($conf->global->RUBIS_LOGO_EDISON)){
			$logo=$conf->mycompany->dir_output.'/logos/'.$conf->global->RUBIS_LOGO_EDISON;
		}else{
