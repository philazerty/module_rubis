 ...
 * Copyright (C) 2017-2020 Philippe SAGOT (Philazerty)  <courrier@mon-dolibarr.fr>
 *
...
class pdf_rubis extends ModelePDFPropales
{
	...
	protected function _tableau_info(&$pdf, $object, $posy, $outputlangs)
	{
		...
		// Ajout du montant de l'acompte  calculer selon un pourcentage
		// Par Philippe SAGOT (philazerty) le 11/01/2016
		$extrafields= new ExtraFields($this->db); // les extrafields de la propale
		...
		if ($depositpercent>0)
		{
			...
			$pdf->SetFont('','B', $default_font_size - 2);
			$deposit = round( ($depositpercent/100) * $object->total_ttc);
			$pdf->MultiCell(90, 3, $outputlangs->transnoentities("RubisPaymentDepositValue").price($deposit, 0, $outputlangs).$outputlangs->transnoentities("RubisPaymentDepositValue2"), 0, 'L', 0);
			$pdf->SetTextColor(0,0,0);
			$posy=$pdf->GetY()+1;
		}
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		//Update by Philazerty for Rubis
		// Load traductions files required by page
		$outputlangs->loadLangs(array("main", "propal", "companies", "bills", "rubis@rubis"));
