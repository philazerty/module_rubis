 ...
 *	\ingroup    propale
 *	\brief      Fichier de la classe permettant de generer les propales au modele rubis
 */
...
class pdf_rubis extends ModelePDFPropales
{
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		if ($conf->propal->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				$pdf->SetCreator("Dolibarr ".DOL_VERSION." with Rubis");
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		if (!empty($conf->global->RUBIS_LOGO_RUBIS)){
			$logo=$conf->mycompany->dir_output.'/logos/'.$conf->global->RUBIS_LOGO_RUBIS;
		}else{
