...
/**
 *	\file       htdocs/core/modules/supplier_order/pdf/pdf_beaujolais.modules.php
 *	\ingroup    fournisseur
 *	\brief      File of class to generate suppliers orders from beaujolais model
 */
...
/**
 *	Class to generate the supplier orders with the beaujolais model
 */
class pdf_beaujolais extends ModelePDFSuppliersOrders
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "beaujolais";
		$this->description = $langs->trans('PDFbeaujolaisDescription');
	...
	$showpricebeforepagebreak=1;
					...
					if ($pageposafter > $pageposbefore)	// There is a pagebreak
					{
						...
						pdf_writelinedesc($pdf,$object,$i,$outputlangs,$this->posxpicture-$curX,4,$curX,$curY,$hideref,$hidedesc,1);
						$posyafter=$pdf->GetY();
