...
/**
 *	\file       htdocs/core/modules/expedition/doc/pdf_epinoche.modules.php
 *	\ingroup    expedition
 *	\brief      Fichier de la classe permettant de generer les bordereaux envoi au modele epinoche
 */
...
/**
 *	Class to build sending documents with model epinoche
 */
class pdf_epinoche extends ModelePdfExpedition
{
    /**
	...
	function __construct($db=0)
	{
		...
		$this->db = $db;
		$this->name = "epinoche";
		$this->description = $langs->trans("PDFepinocheDescription");
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		// Update by Philazerty 
		if (!empty($conf->global->RUBIS_LOGO_EPINOCHE)){
			$logo=$conf->mycompany->dir_output.'/logos/'.$conf->global->RUBIS_LOGO_EPINOCHE;
		}else{
		...
		$pdf->SetXY($posx,$posy);
		$pdf->SetTextColor(0,0,60);
		$pdf->MultiCell($w, 4, $outputlangs->transnoentities("EpinocheShippingDate")." : ".dol_print_date($object->date_creation,"day",false,$outputlangs,true), '', 'R');
